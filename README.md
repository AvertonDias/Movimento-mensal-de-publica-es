...
- **Gestão Colaborativa**: Sistema de convites para ajudantes que podem visualizar e editar o inventário do anfitrião.
- **Histórico e Estatísticas**: Visualização de tendências de movimentação dos últimos 6 meses.
- **IA Generativa**: Sugestões de gestão e análise de tendências baseadas nos dados do inventário.
- **Multi-idioma (Preparado)**: Estrutura pronta para suporte a diferentes idiomas de publicações.
...
2. Configure as variáveis de ambiente do Firebase em `.env`.
