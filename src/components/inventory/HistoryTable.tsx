    ...
    <div className="border border-black relative overflow-hidden print:border-black">
      ...
      <Table className="border-collapse table-fixed w-full min-w-[1250px] print:min-w-0">
        <TableHeader className="print:table-row-group">
          <TableRow className="border-b-2 border-black divide-x divide-black bg-white hover:bg-white h-4">
            ...
            {lastSixMonths.map((month) => (
              <TableHead 
                key={month.key} 
                colSpan={3} 
                className="text-center text-[8px] font-black uppercase text-black p-0 h-4 border-l border-black bg-neutral-50/50"
              >
                {month.label}
              </TableHead>
            ))}
