...
import { BookOpen, LogIn, Info } from "lucide-react";
...
function LoginForm() {
  ...
  useEffect(() => {
    // Se houver um token na URL, salvamos no localStorage antes de qualquer ação
    if (token) {
  ...
  useEffect(() => {
    if (user && !user.isAnonymous) {
      ...
      if (pendingToken) {
        // Se há um convite pendente, redirecionamos para a página de registro 
        // onde a lógica de confirmação e vinculação está centralizada
