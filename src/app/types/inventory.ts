...
export const OFFICIAL_PUBLICATIONS: Omit<InventoryItem, 'id' | 'previous' | 'received' | 'current'>[] = [
  ...
  { code: '6634', item: 'A Vida — Teve um Criador?*', abbr: 'lc', category: 'Brochuras', imageKey: 'lc' },
  ...
  { code: '', item: 'A Sentinela N.º 1 2018*', abbr: 'wp18.1', category: 'Revistas', imageKey: 'wp18.1' },
  { code: '', item: 'A Sentinela N.º 2 2018*', abbr: 'wp18.2', category: 'Revistas', imageKey: 'wp18.2' },
  { code: '', item: 'A Sentinela N.º 3 2018*', abbr: 'wp18.3', category: 'Revistas', imageKey: 'wp18.3' },
  { code: '', item: 'A Sentinela N.º 1 2019*', abbr: 'wp19.1', category: 'Revistas', imageKey: 'wp19.1' },
  { code: '', item: 'A Sentinela N.º 2 2019*', abbr: 'wp19.2', category: 'Revistas', imageKey: 'wp19.2' },
  { code: '', item: 'A Sentinela N.º 3 2019*', abbr: 'wp19.3', category: 'Revistas', imageKey: 'wp19.3' },
  { code: '', item: 'A Sentinela N.º 1 2020*', abbr: 'wp20.1', category: 'Revistas', imageKey: 'wp20.1' },
  { code: '', item: 'A Sentinela N.º 2 2020*', abbr: 'wp20.2', category: 'Revistas', imageKey: 'wp20.2' },
  { code: '', item: 'A Sentinela N.º 3 2020*', abbr: 'wp20.3', category: 'Revistas', imageKey: 'wp20.3' },
  { code: '', item: 'A Sentinela N.º 1 2021*', abbr: 'wp21.1', category: 'Revistas', imageKey: 'wp21.1' },
  { code: '', item: 'A Sentinela N.º 2 2021*', abbr: 'wp21.2', category: 'Revistas', imageKey: 'wp21.2' },
  { code: '', item: 'A Sentinela N.º 3 2021*', abbr: 'wp21.3', category: 'Revistas', imageKey: 'wp21.3' },
  { code: '', item: 'A Sentinela N.º 1 2022*', abbr: 'wp22.1', category: 'Revistas', imageKey: 'wp22.1' },
  { code: '', item: 'A Sentinela N.º 1 2023*', abbr: 'wp23.1', category: 'Revistas', imageKey: 'wp23.1' },
  { code: '', item: 'A Sentinela N.º 1 2024*', abbr: 'wp24.1', category: 'Revistas', imageKey: 'wp24.1' },
  ...
  { code: '', item: 'Despertai! N.º 1 2019*', abbr: 'g19.1', category: 'Revistas', imageKey: 'g19.1' },
  { code: '', item: 'Despertai! N.º 2 2019*', abbr: 'g19.2', category: 'Revistas', imageKey: 'g19.2' },
  { code: '', item: 'Despertai! N.º 3 2019*', abbr: 'g19.3', category: 'Revistas', imageKey: 'g19.3' },
  { code: '', item: 'Despertai! N.º 1 2020*', abbr: 'g20.1', category: 'Revistas', imageKey: 'g20.1' },
  { code: '', item: 'Despertai! N.º 2 2020*', abbr: 'g20.2', category: 'Revistas', imageKey: 'g20.2' },
  { code: '', item: 'Despertai! N.º 3 2020*', abbr: 'g20.3', category: 'Revistas', imageKey: 'g20.3' },
  { code: '', item: 'Despertai! N.º 1 2021*', abbr: 'g21.1', category: 'Revistas', imageKey: 'g21.1' },
  { code: '', item: 'Despertai! N.º 2 2021*', abbr: 'g21.2', category: 'Revistas', imageKey: 'g21.2' },
  { code: '', item: 'Despertai! N.º 3 2021*', abbr: 'g21.3', category: 'Revistas', imageKey: 'g21.3' },
