...
export const OFFICIAL_PUBLICATIONS: Omit<InventoryItem, 'id' | 'previous' | 'received' | 'current'>[] = [
  ...
  { code: '', item: 'Sentinela N.º 1 2019*', abbr: 'wp19.1', category: 'Revistas', imageKey: 'wp19.1' },
  { code: '', item: 'Sentinela N.º 2 2019*', abbr: 'wp19.2', category: 'Revistas', imageKey: 'wp19.2' },
  { code: '', item: 'Sentinela N.º 3 2019*', abbr: 'wp19.3', category: 'Revistas', imageKey: 'wp19.3' },
  { code: '', item: 'Sentinela N.º 1 2020*', abbr: 'wp20.1', category: 'Revistas', imageKey: 'wp20.1' },
  { code: '', item: 'Sentinela N.º 2 2020*', abbr: 'wp20.2', category: 'Revistas', imageKey: 'wp20.2' },
  { code: '', item: 'Sentinela N.º 3 2020*', abbr: 'wp20.3', category: 'Revistas', imageKey: 'wp20.3' },
  { code: '', item: 'Sentinela N.º 1 2021*', abbr: 'wp21.1', category: 'Revistas', imageKey: 'wp21.1' },
  { code: '', item: 'Sentinela N.º 2 2021*', abbr: 'wp21.2', category: 'Revistas', imageKey: 'wp21.2' },
  { code: '', item: 'Sentinela N.º 3 2021*', abbr: 'wp21.3', category: 'Revistas', imageKey: 'wp21.3' },
