...
export const OFFICIAL_PUBLICATIONS: Omit<InventoryItem, 'id' | 'previous' | 'received' | 'current' | 'minStock'>[] = [
  ...
  { code: '6643', item: 'A Vida — Teve um Criador?*', abbr: 'lc', category: 'Brochuras', imageKey: 'lc' },
  ...
  { code: '65445', item: 'Seja Feliz para Sempre! (brochura)*', abbr: 'lffi', category: 'Brochuras', imageKey: 'lffi' },
  { code: '6657', item: 'Escute e Viva*', abbr: 'll', category: 'Brochuras', imageKey: 'll' },
  ...
  { code: '7130', item: 'O Que Você Acha da Bíblia?*', abbr: 'T-30', category: 'Folhetos e convites (1 maço de 2,5 cm = 300)', imageKey: 'T-30' },
  { code: '7131', item: 'O Que Você Espera do Futuro?*', abbr: 'T-31', category: 'Folhetos e convites (1 maço de 2,5 cm = 300)', imageKey: 'T-31' },
  { code: '7132', item: 'Segredo para Família Feliz*', abbr: 'T-32', category: 'Folhetos e convites (1 maço de 2,5 cm = 300)', imageKey: 'T-32' },
  { code: '7133', item: 'Quem Controla o Mundo?*', abbr: 'T-33', category: 'Folhetos e convites (1 maço de 2,5 cm = 300)', imageKey: 'T-33' },
  { code: '7134', item: 'O Sofrimento Vai Acabar?*', abbr: 'T-34', category: 'Folhetos e convites (1 maço de 2,5 cm = 300)', imageKey: 'T-34' },
  ...
  { code: '', item: 'Despertai! N.º 2 2018*', abbr: 'g18.2', category: 'Revistas para o público', imageKey: 'g18.2' },
  { code: '', item: 'Despertai! N.º 3 2018*', abbr: 'g18.3', category: 'Revistas para o público', imageKey: 'g18.3' },
  { code: '', item: 'Despertai! N.º 1 2019*', abbr: 'g19.1', category: 'Revistas para o público', imageKey: 'g19.1' },
  { code: '', item: 'Despertai! N.º 2 2019*', abbr: 'g19.2', category: 'Revistas para o público', imageKey: 'g19.2' },
  { code: '', item: 'Despertai! N.º 3 2019*', abbr: 'g19.3', category: 'Revistas para o público', imageKey: 'g19.3' },
  { code: '', item: 'Despertai! N.º 1 2020*', abbr: 'g20.1', category: 'Revistas para o público', imageKey: 'g20.1' },
  { code: '', item: 'Despertai! N.º 2 2020*', abbr: 'g20.2', category: 'Revistas para o público', imageKey: 'g20.2' },
  { code: '', item: 'Despertai! N.º 3 2020*', abbr: 'g20.3', category: 'Revistas para o público', imageKey: 'g20.3' },
  { code: '', item: 'Despertai! N.º 1 2021*', abbr: 'g21.1', category: 'Revistas para o público', imageKey: 'g21.1' },
  { code: '', item: 'Despertai! N.º 2 2021*', abbr: 'g21.2', category: 'Revistas para o público', imageKey: 'g21.2' },
  { code: '', item: 'Despertai! N.º 3 2021*', abbr: 'g21.3', category: 'Revistas para o público', imageKey: 'g21.3' },
  { code: '', item: 'Despertai! N.º 1 2022*', abbr: 'g22.1', category: 'Revistas para o público', imageKey: 'g22.1' },
  { code: '', item: 'Despertai! N.º 1 2023*', abbr: 'g23.1', category: 'Revistas para o público', imageKey: 'g23.1' },
  { code: '', item: 'Despertai! N.º 1 2024*', abbr: 'g24.1', category: 'Revistas para o público', imageKey: 'g24.1' },
  { code: '', item: 'Despertai! N.º 1 2025*', abbr: 'g25.1', category: 'Revistas para o público', imageKey: 'g25.1' },
  
  { code: '', item: 'Sentinela N.º 1 2018*', abbr: 'wp18.1', category: 'Revistas para o público', imageKey: 'wp18.1' },
  { code: '', item: 'Sentinela N.º 2 2018*', abbr: 'wp18.2', category: 'Revistas para o público', imageKey: 'wp18.2' },
  { code: '', item: 'Sentinela N.º 3 2018*', abbr: 'wp18.3', category: 'Revistas para o público', imageKey: 'wp18.3' },
  { code: '', item: 'Sentinela N.º 1 2019*', abbr: 'wp19.1', category: 'Revistas para o público', imageKey: 'wp19.1' },
  { code: '', item: 'Sentinela N.º 2 2019*', abbr: 'wp19.2', category: 'Revistas para o público', imageKey: 'wp19.2' },
  { code: '', item: 'Sentinela N.º 3 2019*', abbr: 'wp19.3', category: 'Revistas para o público', imageKey: 'wp19.3' },
  { code: '', item: 'Sentinela N.º 1 2020*', abbr: 'wp20.1', category: 'Revistas para o público', imageKey: 'wp20.1' },
  { code: '', item: 'Sentinela N.º 2 2020*', abbr: 'wp20.2', category: 'Revistas para o público', imageKey: 'wp20.2' },
  { code: '', item: 'Sentinela N.º 3 2020*', abbr: 'wp20.3', category: 'Revistas para o público', imageKey: 'wp20.3' },
  { code: '', item: 'Sentinela N.º 1 2021*', abbr: 'wp21.1', category: 'Revistas para o público', imageKey: 'wp21.1' },
  { code: '', item: 'Sentinela N.º 2 2021*', abbr: 'wp21.2', category: 'Revistas para o público', imageKey: 'wp21.2' },
  { code: '', item: 'Sentinela N.º 3 2021*', abbr: 'wp21.3', category: 'Revistas para o público', imageKey: 'wp21.3' },
  { code: '', item: 'Sentinela N.º 1 2022*', abbr: 'wp22.1', category: 'Revistas para o público', imageKey: 'wp22.1' },
