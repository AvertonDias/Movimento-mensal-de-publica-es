...
export const OFFICIAL_PUBLICATIONS: Omit<InventoryItem, 'id' | 'previous' | 'received' | 'current'>[] = [
  ...
  { code: '5001', item: 'Estudo Perspicaz, Vol. 1', abbr: 'it-1', category: 'Livros' },
  { code: '5002', item: 'Estudo Perspicaz, Vol. 2', abbr: 'it-2', category: 'Livros' },
  ...
  { code: '6620', item: 'Um Livro para Todas as Pessoas', abbr: 'ba', category: 'Brochuras' },
  { code: '6625', item: 'Testemunhas de Jeová — Quem São?', abbr: 'jt', category: 'Brochuras' },
  ...
  { code: '7138', item: 'O Reino de Deus — O que é para você?*', abbr: 'T-38', category: 'Folhetos' },
  { code: '7139', item: 'Onde encontrar as respostas?*', abbr: 'T-39', category: 'Folhetos' },
